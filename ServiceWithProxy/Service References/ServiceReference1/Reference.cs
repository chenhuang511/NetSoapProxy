...
namespace ServiceWithProxy.ServiceReference1 {
    ...
    public interface IServices {
        ...
        ServiceWithProxy.ServiceReference1.ProcessResponse Process(ServiceWithProxy.ServiceReference1.ProcessRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServices/Process", ReplyAction="http://tempuri.org/IServices/ProcessResponse")]
        System.Threading.Tasks.Task<ServiceWithProxy.ServiceReference1.ProcessResponse> ProcessAsync(ServiceWithProxy.ServiceReference1.ProcessRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServicesChannel : ServiceWithProxy.ServiceReference1.IServices, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicesClient : System.ServiceModel.ClientBase<ServiceWithProxy.ServiceReference1.IServices>, ServiceWithProxy.ServiceReference1.IServices {
        ...
        ServiceWithProxy.ServiceReference1.ProcessResponse ServiceWithProxy.ServiceReference1.IServices.Process(ServiceWithProxy.ServiceReference1.ProcessRequest request) {
        ...
        public string Process(string token, string userId, string password, string serviceId, string functionCode, string inputParams, byte[] fileAttachment, ref object[] outputVal) {
            ServiceWithProxy.ServiceReference1.ProcessRequest inValue = new ServiceWithProxy.ServiceReference1.ProcessRequest();
            inValue.token = token;
            ...
            ServiceWithProxy.ServiceReference1.ProcessResponse retVal = ((ServiceWithProxy.ServiceReference1.IServices)(this)).Process(inValue);
            outputVal = retVal.outputVal;
            return retVal.ProcessResult;
        }
        
        public System.Threading.Tasks.Task<ServiceWithProxy.ServiceReference1.ProcessResponse> ProcessAsync(ServiceWithProxy.ServiceReference1.ProcessRequest request) {
